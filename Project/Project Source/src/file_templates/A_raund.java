 ...
 */
public class A_raund extends _OneRaund_{

    public A_raund(int raund, int Target_Row, int Target_Colmn, int new_Location_row, int new_Location_colmn, int Yer_degistirme_kare_sayısı, int Old_Location_row, int Old_Location_colmn, boolean _is_alive, boolean _is_captured_gold_in_this_raound, int gold_in_case, int captured_gold, int consume_gold, String Action, int total_Yer_degistirme_kare_sayısı) {
